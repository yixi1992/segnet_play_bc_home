...
~/work/yixi/software/caffe-segnet/build/tools/caffe train -gpu 0 -solver ~/segnet/f1b1/segnet_basic_solver.prototxt -snapshot /home-4/yixi@umd.edu/segnet/f1b1/snapshots/f1b1trgbbs10lr1e-3fixed_iter_12000.solverstate
