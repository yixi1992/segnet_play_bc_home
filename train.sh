...
#~/work/yixi/software/caffe-segnet/build/tools/caffe train -gpu 0 -solver ~/work/yixi/segnet/segnetf1/segnet_basic_solver.prototxt -snapshot /scratch/groups/lsdavis/yixi/segnet/segnetf1/snapshots/scratchgglr1e-1fixed_iter_10000.solverstate
